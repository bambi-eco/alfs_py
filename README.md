...
- APPLY_NMS: Wheter non-maximum-suppression should be used (True) to merge labels or keeping all labels (False) (default: 0; True)
- NMS_IOU: Intersection-over-union parameter used of non-maximum-suppression (Default: 0.9)
- IS_THERMAL: Flag if thermal data (True) is rendered or rgb data (False). Only difference is which distortion mask is used for rendering (default: 1; True)
