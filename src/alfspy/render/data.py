...
class CameraPositioningMode(Enum):
    ...
    :cvar BackgroundCentered: The camera is placed at the XY-center and just outside the AABB along the Z-axis of the background object.
    :cvar FirstShot: The camera takes the position of the first shot.
    :cvar CenterShot: The camera takes the position of the shot at position ``n/2`` given ``n`` shots.
    :cvar LastShot: The camera takes the position of the last shot.
    :cvar AverageShot: The camera is placed at the average position of all shots.
    :cvar ShotCentered: The camera is placed at the center of the smallest AABB enclosing all shot positions.
    """
    BackgroundCentered = 0x000001
    FirstShot          = 0x000010
    CenterShot         = 0x000100
    LastShot           = 0x001000
    AverageShot        = 0x010000
    ShotCentered       = 0x100000
...
class BaseSettings:
    ...
    camera_position_mode: CameraPositioningMode = CameraPositioningMode.BackgroundCentered
